...
public abstract class Lab(AIProjectClient client, string modelName) : IAsyncDisposable
{
    ...
    protected PersistentAgentsClient? agentClient;
    ...
    public async Task RunAsync()
    {
        ...
        agentClient = Client.GetPersistentAgentsClient();
    ...
    protected virtual Task InitialiseLabAsync(PersistentAgentsClient agentClient) => Task.CompletedTask;
    ...
    private async Task DownloadImageFileContentAsync(MessageImageFileContent imageContent)
    {
        ...
        BinaryData fileContent = await agentClient.Files.GetFileContentAsync(imageContent.FileId);
    ...
    private async Task HandleActionAsync(RequiredActionUpdate requiredActionUpdate)
    {
        ...
        else
        {
            ...
            toolOutputUpdate = agentClient.Runs.SubmitToolOutputsToStreamAsync(
